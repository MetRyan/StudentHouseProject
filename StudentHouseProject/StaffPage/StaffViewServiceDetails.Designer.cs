namespace StudentHouseProject.StaffPage
{
    partial class StaffViewServiceDetails
    {
        ...
        private void InitializeComponent()
        {
            ...
            dgvProductDetails.Location = new Point(113, 223);
            ...
            dgvProductDetails.Size = new Size(646, 222);
            dgvProductDetails.TabIndex = 49;
            // 
            // txtPhone
            // 
            txtPhone.Location = new Point(576, 134);
            ...
            cbPending.Location = new Point(576, 80);
            cbPending.Margin = new Padding(3, 2, 3, 2);
            cbPending.Name = "cbPending";
            cbPending.Size = new Size(183, 23);
            cbPending.TabIndex = 47;
            // 
            // txtAddress
            // 
            txtAddress.Location = new Point(209, 134);
            ...
            label5.Location = new Point(485, 137);
            label5.Name = "label5";
            ...
            label4.Location = new Point(485, 83);
            label4.Name = "label4";
            ...
            label6.Location = new Point(113, 137);
            label6.Name = "label6";
            ...
            button2.Location = new Point(576, 182);
            ...
            // txtName
            // 
            txtName.Location = new Point(209, 80);
            ...
            label8.Location = new Point(113, 83);
            label8.Name = "label8";
            ...
            label1.Location = new Point(113, 185);
            label1.Name = "label1";
            label1.Size = new Size(70, 15);
            label1.TabIndex = 50;
            label1.Text = "Work Status";
            // 
            // cbStatusWork
            // 
            cbStatusWork.DropDownStyle = ComboBoxStyle.DropDownList;
            cbStatusWork.FormattingEnabled = true;
            cbStatusWork.Items.AddRange(new object[] { "True", "False" });
            cbStatusWork.Location = new Point(209, 182);
            cbStatusWork.Name = "cbStatusWork";
            cbStatusWork.Size = new Size(183, 23);
